...
if (strlen($_SESSION['bpmsaid']==0)) {
  ...
  $eid=$_GET['editid'];
     ...
     $query=mysqli_query($con, "update khachhang set  tennd='$aname', sdt='$mobno', diachi='$diachi', email='$email',gioitinh='$gioitinh' where ID='$eid'");
    if ($query) {
...
?>
							 ...
							 <?php if($row['gioitinh']=="Male")
{?><input type="radio" id="gioitinh" name="gioitinh" value="Male" checked="true">Male &emsp;

                     <input type="radio" name="gioitinh" value="Female"> Female &emsp;
                   <?php } 
else 
{?><input type="radio" id="gioitinh" name="gioitinh" value="Male" >Male &emsp;

                     <input type="radio" name="gioitinh" value="Female" checked="true">Female &emsp;
                   <?php } ?>
</div>
