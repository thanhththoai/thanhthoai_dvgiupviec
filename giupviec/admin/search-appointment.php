...
<?php
$ret=mysqli_query($con,"select *from  lichhen where malichhen like '%$sdata%' || ten like '%$sdata%' || sdt like '%$sdata%'");
...
?>
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['malichhen'];?></td> <td><?php  echo $row['ten'];?></td><td><?php  echo $row['sdt'];?></td><td><?php  echo $row['ngayhen'];?></td> <td><?php  echo $row['thoigian'];?></td> <td><a href="view-appointment.php?viewid=<?php echo $row['ID'];?>">View</a></td> </tr>   <?php 
$cnt=$cnt+1;
} } else { ?>
  <tr>
