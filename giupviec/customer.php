...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID from khachhang where  tennd='$adminuser' && password='$password' ");
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
							...
							<div class="forgot">
									<a href="index.php">Quay lại trang chủ </p></a>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="forgot-grid">
								<div class="forgot">
									<a href="login.php" style="color:red">Đăng ký tài khoản </p></a>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="forgot-grid">
